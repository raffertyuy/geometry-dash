...
- [ ] T019 [US1] Make all unit tests from T012, T013, T014 pass. Iterate on the implementation files from T016, T017, T018 only until green.
- [ ] T020 [US1] Make the integration test from T015 pass (depends on T016-T018 being green individually first).
